...
# --- Hide proxy so you don't see both Job and DwpJob ---
try:
...
class JobScrapeLogAdmin(ReadOnlyAdminMixin, admin.ModelAdmin):
    list_display = (
        "created_at",
        "status",
        "job_id",
...
class DwpJobAdmin(ReadOnlyAdminMixin, admin.ModelAdmin):
    list_display = (
        "job_id",
        "title",
        "company",
