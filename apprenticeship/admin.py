...
class ApprenticeshipVacancyAdmin(ReadOnlyAdminMixin, admin.ModelAdmin):
    list_display = (
        "vacancy_ref",
        "title",
        "employer_name",
    ...
    fieldsets = (
        ...
        ("Header", {"fields": ("title", "employer_name", "location_summary", "closing_text", "posted_text")}),
        (
            "Summary",
            {
                "fields": (
        ...
        (
            "Requirements",
            {"fields": ("essential_qualifications", "skills_items", "other_requirements_items")},
        ),
        ("About employer", {"fields": ("about_employer", "employer_website", "company_benefits_items")}),
...
class ApprenticeshipScrapeLogAdmin(ReadOnlyAdminMixin, admin.ModelAdmin):
    list_display = (
        "created_at",
        "status",
        "category",
